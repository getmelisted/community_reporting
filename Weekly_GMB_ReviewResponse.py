...
def SendEmail(attachments):
    ...
    postmark.emails.send(
                         ...
                         Subject='Weekly GMB Review Response Community Results',
                         HtmlBody= 'Please find attached the GMB Review Response Community Results associated to Work Orders for the previous week.',
...
def main():
    ...
    file = "./Archive/WeeklyGMBCommunityReviewResponse - " + str(sunday) + " to " + str(saturday) + ".csv"
    ...
    file2 = "./Archive/RAW_WeeklyGMBCommunityReviewResponse - " + str(sunday) + " to " + str(saturday) + ".csv"
