...
def main():
    ...
    file = "./Archive/WeeklyFacebookCommunityResults - " + str(sunday) + " to " + str(saturday) + ".csv"

    arrays =[totalwoattempt, wotoattempt2, wotopubaudit, wotosubpending, wotofailed, pertoattempt2, pertopubaudit, pertosubpending, pertofailed, pertopubauditupdate, perupdatepubaudit, averageage]
    writeCSV(arrays, file)
    
    file2 = "./Archive/RAW_WeeklyFacebookCommunityResults - " + str(sunday) + " to " + str(saturday) + ".csv"
